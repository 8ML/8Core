package net.clubcraft.core.player.stats.ui.pages;
/*
...
import net.clubcraft.core.ui.component.components.Label;
...
public class StatsPage extends Page {
    ...
    public void onOpen() {
        ...
        Label leveling = new Label(ChatColor.YELLOW + "Clubcraft Leveling", Material.ENCHANTED_BOOK, getParent());
